...
- **Crash-safe restart sealing**: The tracker stores a lightweight local heartbeat so stale open sessions are sealed near the last live poll instead of stretching all the way to the next app startup.
